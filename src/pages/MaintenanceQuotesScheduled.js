...
import {headings, subText, tileImg, greenPill, orangePill, redPill, blue, xSmall,} from "../utils/styles";
...
function MaintenanceQuotesScheduled(props) {
    ...
    return (
        <div className="h-100 d-flex flex-column">
            <Header title="Quotes Accepted" leftText="< Back"
            ...
            <Container className="pt-1 mb-5">
                ...
                {quotes_scheduled && quotes.length > 0 && quotes_scheduled.map((quote, i) => (
                    <Row className="mt-2 mb-2" key={i}
                        ...
                        <Col className=''>
                            ...
                            <p className='pt-1 d-flex justify-content-between align-items-center' style={subText}>
                                {quote.description}
                            </p>
                            ...
                            <div className='d-flex '>
                                <div className='flex-grow-1 d-flex flex-column justify-content-center'>
                                    <p style={blue} className='mb-0'>
                                        {quote.address}{quote.unit !== '' ? ' '+quote.unit : ''}, {quote.city},
            ...
            <Container className="pt-1 mb-5">
                ...
                {quotes_accepted && quotes.length > 0 && quotes_accepted.map((quote, i) => (
                    <Row className="mt-2 mb-2" key={i}
                         onClick={() =>
                             navigate(`./${quote.maintenance_quote_uid}`, { state: {quote: quote }})}>
                        <Col xs={4}>
