    ...
    return (
        ...
        <div className="h-100 d-flex flex-column">
            <Header
                title="Profile"
                leftText="< Back"
                leftFn={() => navigate(`/tenantPropertyView`)}
                rightText="Edit"
...
{/* =======================================Send Button================================================ */}
            ...
            >
                {" "}
                <Button variant='outline-primary' style={bluePillButton} onClick={goToShowApplied}>Send Application to rent</Button>
            </Col>
            </Row>
        </div>
