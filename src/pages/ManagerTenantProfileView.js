...
function ManagerTenantProfileView(props) {
    ...
    const tenant_current_address = `${address.street}, ${address.unit ? `Unit ${address.unit}` : ''}, ${address.city}, ${address.state}, ${address.zip}`
            ...
            <Container>
                ...
                <Row className="my-2">
                    <Col>
                        ...
                        <p style={gray}>
                            {((tenant_current_address !== null) && (tenant_current_address !== 'null')) ?
