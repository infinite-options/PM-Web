...
export default function ManagerDashboard() {
  ...
  const fetchManagerDashboard = async () => {
    ...
    setManagerData(properties_unique);
    setIsLoading(false);
    let requests = [];
  ...
  return stage === "LIST" ? (
    <div className="w-100 overflow-hidden">
      {!isLoading && managerData.length > 1 ? (
                ...
                >
                  ...
                  <TableBody>
                    ...
                    <TableRow hidden={!monthlyRevenue}>
                      ...
                      <TableCell width="180px" align="right">
                        ${cashflowData.amortized_maintenance_revenue.toFixed(2)}
                      </TableCell>
                      <TableCell width="180px" align="right">
                        $
                    ...
                    <TableRow hidden={!yearlyCashFlow}>
                      ...
                      <TableCell width="180px" align="right">
                        $
                        {(yearRevenueTotal - yearRevenueExpectedTotal).toFixed(
                          2
                        )}
                      </TableCell>
                      <TableCell width="180px" align="right">
                    ...
                    <TableRow hidden={!yearlyRevenue}>
                      ...
                      <TableCell width="180px" align="right">
                        ${cashflowData.repairs_year_expected_revenue.toFixed(2)}
                      </TableCell>
                      <TableCell width="180px" align="right">
                        $
                        {(
                      ...
                      <TableCell width="180px" align="right">
                        $
                        {cashflowData.amortized_repairs_year_revenue.toFixed(2)}
                      </TableCell>
                      <TableCell width="180px" align="right">
                        $
                    ...
                    <TableRow hidden={!yearlyCashFlow}>
                      ...
                      <TableCell width="180px" align="right">
                        $
                        {(yearExpenseTotal - yearExpenseExpectedTotal).toFixed(
                          2
                        )}
                      </TableCell>
                      <TableCell width="180px" align="right">
        ...
        <div className="flex-1">
          ...
          <div className="w-100 mb-5">
            <ManagerPropertyView property_uid={managerData[0].property_uid} />
          </div>
          {/* <div hidden={responsive.showSidebar} className="w-100 mt-3">
            <ManagerFooter />
          </div> */}
        </div>
      ) : !isLoading && managerData.length == 0 ? (
        <div className="flex-1">
          <div
            hidden={!responsive.showSidebar}
            style={{
