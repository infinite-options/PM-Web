...
function PropertyManagerDocs(props) {
  ...
  return (
    <div className="d-flex flex-column gap-2">
      ...
      {(property.management_status === "ACCEPTED" || property.management_status === "SENT") && activeContract ?
          (
              <div>
                <div className="d-flex">
                  <div className='flex-grow-1'>
                    <h6>Contract Name</h6>
                    <p>{activeContract.contract_name ? activeContract.contract_name : "Unnamed Contract"}{" "}
                      ({activeContract.contract_uid})</p>
                  </div>
                  <div>
                    <img src={Edit} alt='Edit' onClick={() => selectContract(activeContract)}/>
                  </div>
                </div>
                ...
                <Row className="my-2">
                  ...
                  {activeContract.fees.map((fee, i) => (
                      <div key={i}>
                        <Row>
                          <Col><p className="mb-1">{fee.fee_name}</p></Col>
                          <Col>
