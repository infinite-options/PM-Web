...
function TenantDuePayments(props) {
    ...
    return <div className="h-100" style={{backgroundColor: '#E9E9E9', font: 'Bahnschrift'}}>
        <Header 
            customClass={"mb-2"}
            title="Due Payments"
            leftText={`< Back`}
        ...
        <Container style={{borderRadius: '10px', margin: '2%', backgroundColor: 'white', width: '96%', minHeight: '90%'}}>
            ...
            <Row>
                <div style={{width: '100%', textAlign: 'center', marginTop: '20px', fontSize: '20px'}}>Due Payments</div>
            </Row>
            ...
            {duePayments.length > 0 ?
                <Row>
                    <div style={{marginTop: '28px', height: 'auto'}}>
                        <div style={{ border:'solid', borderBottom: 'none', display:'flex', flexDirection: 'row', width: '98%', margin: '0% 1% 0% 1%', height: '40px',  borderRadius:'10px 10px 0 0'}}>
                            <div style={{marginRight: '0px', width: '50px', textAlign: 'center', fontSize: '20px'}}>Pay?</div>
                            <div style={{marginRight: '0px', width: '90px', textAlign: 'center', fontSize: '20px'}}>Amount</div>
                            <div style={{marginRight: '0px', width: '90px', textAlign: 'center', fontSize: '20px'}}>Due</div>
                            <div style={{textAlign: 'center', fontSize: '20px', width: '130px'}}>Reason</div>
                        </div>
                                ...
                                <ul style={{overflowY: 'visible', listStyle: 'none', overflow: 'scroll', overflowX: 'hidden', padding: '0px'}}>
                                    {duePayments.map((expense, i) => {
                                        if (!includedUIDs.includes(expense.purchase_uid)) {
                                            ...
                                            return <DueExpenseItem expense={expense} calculate={calculateTotal} add={addPayment}/>
                                        } 
                                    })}
                                </ul> 
                                : 
            ...
            <Row>
                <div style={{width: '100%', textAlign: 'center', marginTop: '20px', fontSize: '20px'}}>Upcoming Payments</div>
            </Row>
