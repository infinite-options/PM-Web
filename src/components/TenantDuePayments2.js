        ...
        <div className="main-content2">
          ...
          <div id="payment-options2">
            <button
              className="pay1"
              style={{
                backgroundColor: paymentOptions[0].isActive
                  ? "rgb(181, 180, 180)"
                  : "white",
              }}
            ...
            <button
              className="pay1"
              style={{
                backgroundColor: paymentOptions[1].isActive
                  ? "rgb(181, 180, 180)"
                  : "white",
              }}
            ...
            <button
              className="pay1"
              style={{
                backgroundColor: paymentOptions[2].isActive
                  ? "rgb(181, 180, 180)"
                  : "white",
              }}
            ...
            <button
              className="pay1"
              style={{
                backgroundColor: paymentOptions[3].isActive
                  ? "rgb(181, 180, 180)"
                  : "white",
              }}
