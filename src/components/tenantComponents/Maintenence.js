      ...
      return (
        <tr>
          ...
          <th className="table-col">
            {row.request_created_date.substring(0, 10)}
          </th>
          <th className="table-col date-cell">
            {numDays(created_date, current)}
          </th>
            ...
            {imgUrl.length > 1 ? (
              <div className="img-orientation">
                ...
                <img
                  alt="maintenance"
                  src={
                    imgUrl.length > currentImg ? imgUrl[currentImg] : imgUrl[0]
                  }
                  className="table-img multi-img-cell rel"
                ></img>
              ...
              <div className="img-orientation">
                <img
                  alt="maintenance"
                  src={imgUrl[0]}
                  className="table-img multi-img-cell"
                ></img>
              </div>
            )}
          </th>
      ...
      <table className="table-upcoming-payments">
        ...
        <tbody>
          ...
          {exists ? (
            ...
            <tr className="table-row no-data"> No recent requests</tr>
          )}
        </tbody>
      </table>
    </div>
